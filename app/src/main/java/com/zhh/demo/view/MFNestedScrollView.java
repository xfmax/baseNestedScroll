 ...
 * @date 2019-12-01.
 */
public class MFNestedScrollView extends NestedScrollView{
    ...
    public MFNestedScrollView(@NonNull Context context) {
        super(context);
    }

    public MFNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MFNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
